  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.pitanja}>
            <Accordion maxH="6rem" title="Tek počinjem da treniram, koliko puta nedeljno bih trebala da imam treninge?">
                <p>Za većinu početnika, <strong>3 treninga nedeljno je optimalno</strong>. Sve ispod toga je jednostavno premalo, a preko toga dolazi do preopterećenja i uglavnom odustajanja. Zato je najbolje početi sa 3 treninga, a nakon mesec dana, ili kada se za tim pokaže potreba, postepeno povećavamo broj treninga, ubacujemo trčanje i slično.</p>
            </Accordion>
            ...
            <Accordion title="Koliko treba da traje dobar trening?">
